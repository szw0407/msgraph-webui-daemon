...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, getResponseStatusText } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/@vue/shared/dist/shared.cjs.js';
import { Client } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/@microsoft/microsoft-graph-client/lib/src/index.js';
import { promises, existsSync, mkdirSync, readFileSync, writeFileSync } from 'node:fs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/vue/index.mjs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/.data/kv"}));
...
const _Mi5T9mka2oOZHwtZWd6K82fgH5Obe7RQuO_Ap3ywb2w = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon";
...
const _7dqHmz6smpxACovsxC6Cxt5i4yTHgQMy9EkttTfnl4o = (nitroApp) => {
...
const plugins = [
  _Mi5T9mka2oOZHwtZWd6K82fgH5Obe7RQuO_Ap3ywb2w,
_7dqHmz6smpxACovsxC6Cxt5i4yTHgQMy9EkttTfnl4o
];
...
const _4M10Kl = eventHandler((event) => {
...
const getServerEntry = () => import('file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_A6UzY_ = () => Promise.resolve().then(function () { return callback_post$1; });
const _lazy_O5GCOn = () => Promise.resolve().then(function () { return events_get$1; });
const _lazy_xbo9d9 = () => Promise.resolve().then(function () { return login_get$1; });
const _lazy_Ee3Bd6 = () => Promise.resolve().then(function () { return logout_post$1; });
const _lazy_XEmPCU = () => Promise.resolve().then(function () { return users_get$1; });
const _lazy_EgQr1T = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _4M10Kl, lazy: false, middleware: true, method: undefined },
  { route: '/api/auth/callback', handler: _lazy_A6UzY_, lazy: true, middleware: false, method: "post" },
  { route: '/api/events', handler: _lazy_O5GCOn, lazy: true, middleware: false, method: "get" },
  { route: '/api/login', handler: _lazy_xbo9d9, lazy: true, middleware: false, method: "get" },
  { route: '/api/logout', handler: _lazy_Ee3Bd6, lazy: true, middleware: false, method: "post" },
  { route: '/api/users', handler: _lazy_XEmPCU, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_EgQr1T, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_EgQr1T, lazy: true, middleware: false, method: undefined }
];
...
class CacheManager {
  constructor() {
    __publicField$1(this, "tokenData", /* @__PURE__ */ new Map());
    __publicField$1(this, "userProfiles", /* @__PURE__ */ new Map());
    __publicField$1(this, "cachedEvents", /* @__PURE__ */ new Map());
    __publicField$1(this, "cacheTimestamps", /* @__PURE__ */ new Map());
    __publicField$1(this, "dataDir", join(process.cwd(), "data"));
    __publicField$1(this, "tokensFile", join(this.dataDir, "tokens.json"));
    __publicField$1(this, "usersFile", join(this.dataDir, "users.json"));
    __publicField$1(this, "eventsFile", join(this.dataDir, "events.json"));
    this.ensureDataDir();
    this.loadFromDisk();
  }
  ensureDataDir() {
  ...
  // Token management
  storeTokenData(userId, tokenData) {
  ...
  isTokenExpired(userId) {
    const tokenData = this.tokenData.get(userId);
    if (!(tokenData == null ? void 0 : tokenData.expiresAt)) {
      return false;
    }
  ...
  getCacheTimestamp(userId) {
    return this.cacheTimestamps.get(userId);
  }
  isCacheValid(userId, maxAgeMs = 3e5) {
...
class CalendarService {
  ...
  async getTodayEvents(accessToken) {
    try {
      ...
      const events = await graphClient.api("/me/calendar/calendarView").query({
      ...
      const calendarEvents = events.value.map((event) => ({
        ...
        onlineMeetingUrl: event.onlineMeetingUrl || void 0
      }));
...
class AuthController {
  constructor() {
    __publicField(this, "cacheManager", getCacheManager());
    __publicField(this, "calendarService", getCalendarService());
  }
  async initiateLogin() {
    try {
      const config = useRuntimeConfig();
