declare global {
  const { AuthController, getAuthController }: typeof import('../../server/utils/AuthController')
  const { CacheManager, getCacheManager }: typeof import('../../server/utils/CacheManager')
  const { CalendarService, getCalendarService }: typeof import('../../server/utils/CalendarService')
...
declare global {
  // @ts-ignore
  export type { AuthController } from '../../server/utils/AuthController'
  import('../../server/utils/AuthController')
  // @ts-ignore
  export type { CacheManager } from '../../server/utils/CacheManager'
  import('../../server/utils/CacheManager')
  // @ts-ignore
  export type { CalendarService } from '../../server/utils/CalendarService'
  import('../../server/utils/CalendarService')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/nuxt/dist/core/runtime/nitro/utils/paths';
export { defineAppConfig } from '/home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/node_modules/nuxt/dist/core/runtime/nitro/utils/config';
export { AuthController, getAuthController } from '/home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/server/utils/AuthController';
export { CacheManager, getCacheManager } from '/home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/server/utils/CacheManager';
export { CalendarService, getCalendarService } from '/home/runner/work/msgraph-webui-daemon/msgraph-webui-daemon/server/utils/CalendarService';